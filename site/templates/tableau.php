...
<div class="content">
	...
	<div class="sheet art">
		...
		<div><span class="bold">Nom de la peinture :</span> <?php echo $page->realname() ?></div>
		<div><span class="bold">Nom du peintre :</span> <?php echo $page->realauthor() ?></div>
		...
		<div><span class="bold">Période :</span> <?php echo $page->periode() ?></div>
