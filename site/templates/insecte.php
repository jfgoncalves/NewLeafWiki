...
<div class="content">
	...
	<div class="sheet bug">
		...
		<div id="pic">
			<?php
			$pic = $page->images()->find('insecte.png');
			if ($pic !== NULL) {
				echo "<img class='insecteThumb' src='".$pic->url()."' />";
			}
		...
		<div><span class="bold">Phrase de capture :</span> "Tu as pris un(e) <?php echo strtolower($page->title()) ?> ! <?php echo $page->catchphrase() ?>"</div>
